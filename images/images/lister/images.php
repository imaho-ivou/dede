        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="d-xl-flex justify-content-between align-items-start">
              <h2 class="text-dark font-weight-bold mb-2"> Gestion images   <a href="http://localhost/pronostics/webadmin/modules/images/ajouter/ajouter_images.php"><label class="badge badge-success">Ajouter</label></a></h2>
